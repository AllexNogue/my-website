...
<!-- Mirrored from astylers.com/web/bleak/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Apr 2021 19:32:03 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">

    <link rel="icon" href="images/favicon.png">
    <title>Allex Nogue - Full Stack Developer</title>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="intro-image">
                                <img src="images/allex_nogue.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="content-left">
                            ...
                            <div class="content">
                                ...
                                <p>Autodidata em programação, sempre buscando novos conhecimentos na área de desenvolvimento para web e software, como programação front end e back end. - Conhecimentos sólidos em HTML5, CSS3. - Web responsivo com a metodologia mobile-first. Criação de aplicações Desktop em Delphi/Pascal C#. e no back-end POO com padrão MVC, Laravel, CakePHP, Codeigniter. Experiência com Arduino Uno R3, desenvolvimento de protótipos por hobbie</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12">
        ...
        <div class="container">
            <div class="box-content">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="content-right">
                            <form action="http://astylers.com/web/bleak/contact-form.php" class="contact-form" id="contact-form" method="post">
                                <div class="row">
                                    <div class="col">
...
<!-- Mirrored from astylers.com/web/bleak/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Apr 2021 19:32:23 GMT -->
</html>